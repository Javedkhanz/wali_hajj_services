        ...
        <div class="container mx-auto px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg">
                    <img src="./quilty.PNG" alt="Quality" class="h-15 w-auto mb-4">
                ...
                <div class="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg">
                    <img src="./experiance.PNG" alt="Experience" class="h-15 w-auto mb-4">
                ...
                <!-- Another feature card -->
                <div class="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg">
                    <img src="./direction.PNG" alt="Guidance" class="h-15 w-auto mb-4">
